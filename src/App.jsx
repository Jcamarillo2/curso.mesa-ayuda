...
import TicketsInforme from "./pages/Tickets/TicketsInforme";
import Tableros from "./pages/Tableros/Tableros";
import ChangePass from "./pages/ChangePass/ChangePass.jsx";
import ModalTicket from "./components/ConsultaTicket/ModalTicket.jsx";
...
const App = () => {
  ...
  const {selectedDateInicio, selectedDateFin, loadRegsTIckets, regsTickets} = useContext(GraphContext)
      ...
      <HashRouter>
        <Switch>
          ...
          */}
          ...
          <Route exact path={rutaServidor + "/tableros"}>
              {user ? <Tableros /> :  <Login/> }                                                             
          </Route> 
          <Route exact path={rutaServidor + "/informe"}>
              {user ? <TicketsInforme /> :  <Login/> }                                                             
          </Route>             
          <Route exact path={rutaServidor + "/changepw"}>
              {user ? <ChangePass /> :  <Login/> }                                                             
          </Route>  
